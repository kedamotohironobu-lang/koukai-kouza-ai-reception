// STEP10-5 GitHub Pages + Cloudflare Workers + Apps Script deployment settings.
...
window.DEPLOYMENT_CONFIG = Object.freeze({
  ...
  receptionSubmitEndpoint: 'https://koukai-kouza-gemini-token.kedamoto-hironobu.workers.dev/api/reception-submit'
});
